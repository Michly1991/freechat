...
function modelScopeLabel(cfg?: any) {
  ...
  if (cfg.scope === 'room_override') return '本房间覆盖'
  if (cfg.scope === 'agent_default' || cfg.inheritedFromAgent) return '继承默认'
  return ''
}
