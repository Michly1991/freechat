    ...
    <div className="h-full flex flex-col">
      ...
      <form onSubmit={sendMessage} className="fc-mobile-glass p-3 sm:p-4 bg-white border-t border-gray-200 shrink-0 relative safe-area-inset-bottom">
        ...
        <div className="mb-2 rounded-2xl border border-gray-200 bg-white px-3 py-2 shadow-sm">
          <button type="button" onClick={() => attachmentInputRef.current?.click()} className="fc-pressable fc-mobile-touch flex w-full items-center justify-center gap-2 rounded-xl border border-dashed border-blue-200 bg-blue-50/70 px-3 py-2.5 text-sm font-medium text-blue-600 hover:bg-blue-100" title="选择文件" aria-label="选择文件"><Paperclip className="h-4 w-4" />选择文件/图片发送给当前聊天</button>
        </div>
