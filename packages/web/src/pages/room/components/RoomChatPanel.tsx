    ...
    <div className="h-full flex flex-col">
      ...
      <form onSubmit={sendMessage} className="fc-mobile-glass p-3 sm:p-4 bg-white border-t border-gray-200 shrink-0 relative safe-area-inset-bottom">
        ...
        <div className="flex gap-2 items-center rounded-2xl bg-gray-50 border border-gray-200 p-1.5 shadow-inner focus-within:ring-2 focus-within:ring-blue-100 focus-within:border-blue-300 transition-all">
          <label className="fc-pressable fc-mobile-touch relative inline-flex min-w-11 shrink-0 cursor-pointer items-center justify-center overflow-hidden rounded-xl px-2.5 py-2 text-gray-500 hover:bg-white hover:text-blue-600" title="上传图片/文件" aria-label="上传图片/文件"><Paperclip className="h-5 w-5" /><input ref={attachmentInputRef} type="file" multiple className="absolute inset-0 h-full w-full cursor-pointer opacity-0" onChange={handleAttachmentChange} /></label>
