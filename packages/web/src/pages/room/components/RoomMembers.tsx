...
export function DesktopMembersPanel({ showMembers, setShowMembers, members, roomAgents, openMemberProfile, restartAgent, openModelConfig, roomId, feedback, onMembersChanged }: any) {
