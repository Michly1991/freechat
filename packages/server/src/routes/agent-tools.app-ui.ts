...
const TOOL_NAMES = [
  ...
  'pdf.read', 'excel.read', 'excel.write', 'word.read', 'word.write', 'ppt.read', 'ppt.write', 'image.read', 'mindmap.create', 'mindmap.save',
  ...
  'agent.my-list', 'agent.list-available', 'agent.room-list', 'agent.create-request', 'agent.add', 'agent.remove', 'agent.restart',
