...
export const APP_ACTIONS: AppActionMeta[] = [
  ...
  { action: 'pdf.read', title: '读取 PDF', category: 'pdf', risk: 'read', description: '提取 PDF 文本。', args: { ref: 'file:<id> 或路径', pageRange: '页码范围，如 1-3' }, ui: '文件面板' },
  { action: 'excel.read', title: '读取 Excel', category: 'excel', risk: 'read', description: '读取 Excel sheet/range。', args: { ref: 'file:<id> 或路径', sheet: '工作表名', range: 'A1:D20' }, ui: '文件面板' },
  { action: 'excel.write', title: '写入 Excel', category: 'excel', risk: 'normal_write', description: '生成 Excel 文件并写回当前房间。', args: { targetPath: '输出路径 .xlsx', rows: '二维数组或 csv' }, ui: '文件面板' },
  { action: 'word.read', title: '读取 Word', category: 'word', risk: 'read', description: '提取 docx 文本。', args: { ref: 'file:<id> 或路径' }, ui: '文件面板' },
  { action: 'word.write', title: '写入 Word', category: 'word', risk: 'normal_write', description: '生成 docx 文件并写回当前房间。', args: { targetPath: '输出路径 .docx', content: '正文' }, ui: '文件面板' },
